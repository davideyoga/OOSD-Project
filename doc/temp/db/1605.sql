...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 16, 2017 at 06:25 PM
...
(1, 'admin', 'Admin', 'GamingPlatform', 'admin@gamingplatform.it', 'd033e22ae348aeb5660fc2140aec35850c4da997', 525, 'default.png'),
...
(8, 'Greg', 'Luca', 'Di Gregorio Zitella', 'lucaDiGreg@aaa.it', 'd012f68144ed0f121d3cc330a17eec528c2e7d59', 10, ''),
...
(9, 1, 10, '2017-05-02 00:00:00'),
(10, 1, 11, '2017-05-08 00:00:00'),
(11, 1, 12, '2017-05-01 08:00:00'),
(12, 1, 13, '2017-05-06 05:00:00'),
(13, 1, 13, '2017-05-07 09:00:00'),
(14, 1, 14, '2017-05-03 12:00:00');
...
(5, 1, 1, '2017-05-10 00:00:00'),
(6, 1, 2, '2017-05-14 00:00:00'),
(7, 1, 3, '2017-05-15 00:00:00'),
(8, 1, 4, '2017-05-16 00:00:00'),
(9, 1, 5, '2017-05-16 05:00:00');
...
--
ALTER TABLE `userlevel`
  ADD CONSTRAINT `userlevel_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `userlevel_ibfk_2` FOREIGN KEY (`id_level`) REFERENCES `level` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
