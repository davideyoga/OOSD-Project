       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-8 content-top-2">
				...
				<!--graph-->
		<link rel="stylesheet" href="${context}/css/graph.css">
		<!--//graph-->
							<script src="${context}/js/jquery.flot.js"></script>
									<script>
									$(document).ready(function () {
		...
		<div class="content-mid">
			...
			<div class="col-md-5">
			  ...
			  <!----Calender -------->
			<link rel="stylesheet" href="${context}/css/clndr.css" type="text/css" />
			<script src="${context}/js/underscore-min.js" type="text/javascript"></script>
			<script src= "${context}/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="${context}/js/clndr.js" type="text/javascript"></script>
		...
		<div id="owl-demo" class="owl-carousel text-center">
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="${context}/images/na.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="${context}/images/na1.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="${context}/images/na2.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="${context}/images/na.jpg" alt="name">
			</div>
